...
`
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := config.Bind[TestConfig](tt.key, tt.path, tt.fname, tt.extension)
...
func TestBind_Key(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := config.Bind[TestAppConfig](tt.key, tt.path, tt.fname, tt.extension)
			if (err != nil) != tt.wantErr {
				t.Errorf("Bind() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
...
func TestBindJSONKey(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			tt.setup()
			got, err := config.BindJSONKey[DBConfig](tt.key)
			if (err != nil) != tt.wantErr {
...
`
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := config.BindYAMLKey[DBConfig](tt.key)
			if (err != nil) != tt.wantErr {
